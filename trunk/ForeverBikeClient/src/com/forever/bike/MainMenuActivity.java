...
public class MainMenuActivity extends Activity {
	...
	public class ImageAdapter extends BaseAdapter {
		...
		// 图片资源数组
		private Integer[] mThumbIds = { R.drawable.user, R.drawable.search,
				R.drawable.gift, R.drawable.research, R.drawable.heart,
				R.drawable.weibo
	...
	OnClickListener jifenghaoliLinstener = new OnClickListener() {
		...
		@Override
		public void onClick(View v) {
			Toast.makeText(MainMenuActivity.this, "积分好礼模块正在开发中...",
	...
	OnClickListener youjiangdiaoyanLinstener = new OnClickListener() {
		...
		@Override
		public void onClick(View v) {
			Toast.makeText(MainMenuActivity.this, "有奖调研模块正在开发中...",
					Toast.LENGTH_SHORT).show();
	...
	OnClickListener manyiduLinstener = new OnClickListener() {
		...
		@Override
		public void onClick(View v) {
			Toast.makeText(MainMenuActivity.this, "满意度模块正在开发中...",
					Toast.LENGTH_SHORT).show();
